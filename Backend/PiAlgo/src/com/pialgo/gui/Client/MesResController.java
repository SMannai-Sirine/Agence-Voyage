 ...
 * @author iHoussem
 */
public class MesResController implements Initializable {
    ...
    private void fnVoiture(ActionEvent event) throws IOException {
        Parent etab = FXMLLoader.load(getClass().getResource("MesResVoiture.fxml"));      
    ...
    private void fnTaxi(ActionEvent event) throws IOException {
        Parent etab = FXMLLoader.load(getClass().getResource("MesResTaxi.fxml"));      
        Scene scene = new Scene(etab);
        Stage windows = (Stage)((Node)event.getSource()).getScene().getWindow();
        windows.setScene(scene);
        windows.show();
