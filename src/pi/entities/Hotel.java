...
public class Hotel {
   ...
   public Hotel(){
    ...
    public Hotel( String nom_hotel, int nbetoile, int nbchambre, int nbrestaurant, int nbpiscine, String adresse_rest, String villehotel, String image) {
    ...
    public String toString() {
        return "Hotel{" + "idhotel=" + idhotel + ", nom_hotel=" + nom_hotel + ", nbetoile=" + nbetoile + ", nbchambre=" + nbchambre + ", nbrestaurant=" + nbrestaurant + ", nbpiscine=" + nbpiscine + ", adresse_rest=" + adresse_rest + ", villehotel=" + villehotel + ", image=" + image + '}';
    }
